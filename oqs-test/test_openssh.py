...
##### OQS_TEMPLATE_FRAGMENT_LIST_SIGS_START
    ...
    'ssh-oqsdefault','ssh-dilithium2','ssh-falcon512','ssh-picnicl1full','ssh-picnic3l1','ssh-sphincsharaka128frobust','ssh-sphincssha256128frobust','ssh-sphincsshake256128frobust',
    # hybrid sigs
