...
#define IS_RSA_HYBRID(alg) ( \
				...
				alg == KEY_RSA3072_RAINBOW_I_CLASSIC || \
...
#define IS_OQS_KEY_TYPE(type) ( \
				...
				(type) == KEY_PICNIC3_L1 || \
				(type) == KEY_RAINBOW_I_CLASSIC || \
				(type) == KEY_RAINBOW_III_CLASSIC || \
				(type) == KEY_RAINBOW_V_CLASSIC || \
