...
#endif /* HAVE_NTRU */
#ifdef HAVE_SABER
	do_kex(KEX_ECDH_NISTP384_LIGHTSABER_SHA384);
	do_kex(KEX_ECDH_NISTP384_SABER_SHA384);
	do_kex(KEX_ECDH_NISTP384_FIRESABER_SHA384);
#endif /* HAVE_SABER */
#ifdef HAVE_SIDH
...
#endif /* HAVE_NTRU */
#ifdef HAVE_SABER
	do_kex(KEX_LIGHTSABER_SHA384);
	do_kex(KEX_SABER_SHA384);
	do_kex(KEX_FIRESABER_SHA384);
#endif /* HAVE_SABER */
#ifdef HAVE_SIDH
